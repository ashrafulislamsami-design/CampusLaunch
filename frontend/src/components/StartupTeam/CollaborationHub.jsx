...
const CollaborationHub = ({ teamId, messages: initialMessages = [], documents = [], onRefresh }) => {
                ...
                <div key={doc._id || idx} className="placard p-4 bg-white hover:border-amber-400 transition group relative overflow-hidden" style={{borderRadius: '8px 24px 8px 24px'}}>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <span className="text-[10px] font-bold text-teal-700 bg-teal-50 px-2 py-0.5 border border-teal-100 rounded uppercase tracking-tighter inline-block mt-1">
                        {doc.category}
                      </span>
                    </div>
                  </div>
