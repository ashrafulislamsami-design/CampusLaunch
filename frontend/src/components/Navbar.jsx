      ...
      <div className="max-w-[1880px] mx-auto px-4 sm:px-6 lg:px-10">
        <div className="flex justify-between h-20 items-center">
          ...
          <div className="flex items-center justify-between flex-1">
            {isAuthenticated ? (
              <>
                {/* Centered Navigation Links - Evenly Spaced & Compact */}
                <div className="flex-1 flex justify-evenly items-center px-4 gap-x-2">
                  <Link
                    to="/home"
                    className="text-stone-700 hover:text-teal-700 transition font-bold uppercase tracking-wider text-[9px] lg:text-[10px] whitespace-nowrap"
                  >
                    Dashboard
                  </Link>
                  <Link
                  ...
                  <Link
                    ...
                    className="text-stone-700 hover:text-teal-700 transition font-bold uppercase tracking-wider text-[9px] lg:text-[10px] whitespace-nowrap flex items-center gap-1"
                  ...
                  {user?.role === 'Admin' && (
                    <Link
                      to="/admin"
                      className="text-amber-700 hover:text-amber-900 transition font-black uppercase tracking-wider text-[9px] lg:text-[10px] whitespace-nowrap flex items-center gap-1 border border-amber-300 bg-amber-50 px-2 py-1 rounded"
                    >
                      <ShieldCheck size={12} />
                      Admin
                    </Link>
                  ...
                  <Link
                    to="/notifications"
                    className="relative text-stone-600 hover:text-amber-700 transition"
                    title="Notifications"
                  >
                    <Bell size={20} />
                    {unreadCount > 0 && (
