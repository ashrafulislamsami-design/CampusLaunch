...
import { Rocket, Target, CalendarDays, Coins, Users, Gem, BookOpen, Mic2 } from 'lucide-react';
  ...
  return (
    <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="placard p-8 group flex flex-col justify-between">
          <div>
            <div className="w-16 h-16 bg-gradient-to-br from-pink-100 to-pink-200 border-2 border-pink-300 text-pink-800 rounded-xl flex items-center justify-center mb-6 shadow-sm transform rotate-1 group-hover:rotate-0 transition">
              <Rocket size={32} className="icon-tactile text-pink-900" />
            </div>
            <h2 className="text-2xl font-black text-amber-900 mb-3 font-serif-custom">Browse Startups</h2>
            <p className="text-stone-700 mb-8 min-h-[4rem] font-sans-custom leading-relaxed">
              Explore other student startups, view their achievements, funding rounds, and success stories.
            </p>
          </div>
          <Link
            to="/teams/browse"
            className="w-full text-center bg-pink-800 text-pink-50 font-bold py-3 uppercase tracking-widest text-sm border-2 border-transparent hover:bg-pink-100 hover:text-pink-900 hover:border-pink-400 transition"
            style={{ borderRadius: '8px 24px 8px 24px' }}
          >
            Discover
          </Link>
